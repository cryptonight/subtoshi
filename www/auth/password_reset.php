...
<form class="form-horizontal" role="form" method="post" action="password_reset" name="new_password_form">
    ...
    <div style="margin-bottom: 25px" class="input-group">
        ...
        <input id="user_password_new" type="password" name="user_password_new" pattern=".{6,}" required placeholder="New password" class="form-control" value="" autocomplete="off" />
    </div>

    <div style="margin-bottom: 25px" class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
        <input id="user_password_repeat" type="password" name="user_password_repeat" pattern=".{6,}" required placeholder="Repeat new password" class="form-control" value="" autocomplete="off" />
    </div>
    
    <div style="margin-top:15px" class="form-group">
        <div class="col-sm-12 controls">
            <input type="submit" name="submit_new_password" class="btn btn-success" value="<?php echo WORDING_SUBMIT_NEW_PASSWORD; ?>" />
        </div>
    </div>
</form>
