...
define("EMAIL_PASSWORDRESET_CONTENT", "<h2>Subtoshi.com</h2><h3>Password reset</h3><p>You have requested a password reset.  If you did not request a password reset, you can discard this email.</p>");
...
define("EMAIL_VERIFICATION_CONTENT", "<h2>Subtoshi.com</h2><h3>Account activation</h3><p>Please verify your email address to activate your account.</p>");
